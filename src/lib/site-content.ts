...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    scope: "franchise",
    question: "Что входит в первичный партнёрский комплект?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Формат, город, стадия проекта и объём партнёрства различаются. Поэтому условия фиксируются только после заявки и первичного обсуждения, а информация на сайте не является публичной офертой.",
  },
  {
