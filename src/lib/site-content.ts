...
export const articles: Article[] = [
  ...
  },
  {
    ...
    category: "B2B",
    excerpt:
      "Презентация, продуктовая база, правила 18+, медиафайлы и маршрут запуска для оптовых и региональных запросов.",
    publishedAt: "2026-04-22",
    author: "STILNO",
    body: [
      "Партнёрский пакет помогает быстро понять продукт, ограничения категории и порядок запуска.",
...
export const homeContent = {
  ...
  storesSection: {
    eyebrow: "Где купить",
    title: "Пилотные города и подтверждённые партнёрские каналы для розничных запросов.",
    body:
      "Выберите город, уточните наличие через форму или предложите действующую точку для партнёрского запуска.",
    actions: [
...
export const storesContent = {
  ...
  statusCards: [
    ...
    {
      value: "Запросы",
      label: "розница · опт · партнёрство",
      note: "Все обращения проходят через единую форму.",
    },
  ] satisfies PageStat[],
  supportTitle: "Розничные запросы",
  supportBody:
    "Форма помогает уточнить наличие, задать вопрос по точке STILNO или предложить партнёрский запуск в вашем городе.",
  disclaimer:
    "Сайт не осуществляет дистанционную розничную продажу никотинсодержащей продукции. Информация предназначена для лиц старше 18 лет.",
};
...
export const partnersPageContent = {
  ...
  directionsSection: {
    ...
    body:
      "Компактный ассортиментный лист помогает быстро сравнить вкусы и базовые параметры линейки перед оптовым или региональным обращением.",
  } satisfies SectionContract,
  contactFlowSection: {
